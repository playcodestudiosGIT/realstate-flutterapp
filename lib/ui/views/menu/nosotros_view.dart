            ...
            Column(
              children: [
                WhiteCard(
                  isDrag: false,
                  child: Container(
                    constraints: BoxConstraints(maxWidth: 800, minWidth: 350, maxHeight: 300, minHeight: 300),
                    decoration: BoxDecoration(
                      color: kPrimaryColor,
                      borderRadius: BorderRadius.circular(0)
                    ),
                    child: Center(child: Image(image: NetworkImage('https://res.cloudinary.com/dnejayiiq/image/upload/v1672446892/logo_hnizxp.png'),)),
                  ),
                ),
                      ...
                      child: Column(
                        ...
                        children: [
                          TextRenderer(
                            ...
                            child: Text(
                              'QUIENES SOMOS',
                              style: CustomLabels.h1.copyWith(fontWeight: FontWeight.bold),
                            ),
                          ),
                          SizedBox(height: kDefaultPadding,),
                          Text(
